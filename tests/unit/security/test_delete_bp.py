...
EXEMPT_PREFIXES_GET = (
    'api_bp.delete_bp.static',
)


def test_delete_routes_are_protected(app, client):
    """Make GET/POST requests to ensure delete routes are protected appropriately."""
    for endpoint, (route, methods) in get_route_rules(app, "api_bp.delete_bp").items():
