...
DatasetName: Direct Taxes Averages (Individuals) - Full Population
DatasetCode: WID_TAXAV_DIRECT_IND_P0P100
Description: Average direct taxes across all population percentiles for individuals. Direct taxes include social contributions and personal taxes on income and wealth. Shows the average tax burden across different income groups, representing the redistribution mechanism in the economy.
Unit: >
    VEF; percentile p0p100; ataxcoi992
Source:
  OrganizationCode: WID
  QueryCode: wid_all_data
DatasetProcessorFile: sspi_flask_app/api/core/datasets/wid/wid_taxav_direct_ind_p0p100.py
---
# Corporate Tax
