...
DatasetName: Direct Taxes Averages (Female) - Full Population
DatasetCode: WID_TAXAV_DIRECT_FEMALE_P0P100
Description: Average direct taxes across all population percentiles for female individuals only. Direct taxes include social contributions and personal taxes on income and wealth. Shows the average tax burden across different female income groups, representing gender-specific aspects of the redistribution mechanism.
Unit: >
    VEF; percentile p0p100; ataxfci992
Source:
  OrganizationCode: WID
  QueryCode: wid_all_data
DatasetProcessorFile: sspi_flask_app/api/core/datasets/wid/wid_taxav_direct_female_p0p100.py
---
# Corporate Tax
