...
DatasetName: Net Personal Wealth Averages (Equal - Full Population
DatasetCode: WID_WEALTHAV_NET_EQUALSPLIT_P0P100
Description: Average net personal wealth across all population percentiles for equal-split adults. Resources are split equally within couples while the base unit remains the individual. Net personal wealth is the total value of non-financial and financial assets (housing, land, deposits, bonds, equities, etc.) held by households, minus their debts.
Unit: >
    VND; percentile p0p100; ahwealj992
Source:
  OrganizationCode: WID
  QueryCode: wid_all_data
DatasetProcessorFile: sspi_flask_app/api/core/datasets/wid/wid_wealthav_net_equalsplit_p0p100.py
---
# Net Personal Wealth
