...
DatasetName: Pre-tax National Income Shares (Equal-split Adults)
DatasetCode: WID_NINCSH_PRETAX_EQUALSPLIT_P90P100
Description: Distribution of pre-tax national income shares for the top 10% of earners for equal-split adults. Resources are split equally within couples while the base unit remains the individual. Pre-tax national income is the sum of all pre-tax personal income flows accruing to labor and capital, before taxes and transfers but after pension operations.
Unit: >
    share; percentile p90p100; sptincj992
Source:
  OrganizationCode: WID
  QueryCode: wid_all_data
DatasetProcessorFile: sspi_flask_app/api/core/datasets/wid/wid_nincsh_pretax_equalsplit_p90p100.py
---
