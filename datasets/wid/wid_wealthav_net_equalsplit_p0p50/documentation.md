...
DatasetName: Net Personal Wealth Averages (Equal - Bottom 50%
DatasetCode: WID_WEALTHAV_NET_EQUALSPLIT_P0P50
Description: Average net personal wealth for the bottom 50% of earners for equal-split adults. Resources are split equally within couples while the base unit remains the individual. Net personal wealth is the total value of non-financial and financial assets (housing, land, deposits, bonds, equities, etc.) held by households, minus their debts.
Unit: >
    VND; percentile p0p50; ahwealj992
Source:
  OrganizationCode: WID
  QueryCode: wid_all_data
DatasetProcessorFile: sspi_flask_app/api/core/datasets/wid/wid_wealthav_net_equalsplit_p0p50.py
---
# Net Personal Wealth
