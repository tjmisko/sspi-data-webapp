...
DatasetName: Social Benefits Averages (COI) - Full Population
DatasetCode: WID_BENEFITAV_SOCIAL_COI_P0P100
Description: Average social benefits other than social transfers in kind across all population percentiles for COI (Cost of Income) groups. Social benefits represent government transfers to individuals and households, excluding in-kind transfers. Shows the average benefit distribution patterns across income groups, representing the redistributive role of social programs.
Unit: >
    VEF; percentile p0p100; assbcoi992
Source:
  OrganizationCode: WID
  QueryCode: wid_all_data
DatasetProcessorFile: sspi_flask_app/api/core/datasets/wid/wid_benefitav_social_coi_p0p100.py
---
