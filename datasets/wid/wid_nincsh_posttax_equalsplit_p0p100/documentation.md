...
DatasetName: Post-tax National Income Shares (Equal-split Adults)
DatasetCode: WID_NINCSH_POSTTAX_EQUALSPLIT_P0P100
Description: Distribution of post-tax national income shares across all population percentiles for equal-split adults. Resources are split equally within couples while the base unit remains the individual. Post-tax national income is the sum of primary incomes from all sectors minus taxes, reflecting income distribution after the operation of the tax and transfer system.
Unit: >
    share; percentile p0p100; sdiincj992
Source:
  OrganizationCode: WID
  QueryCode: wid_all_data
DatasetProcessorFile: sspi_flask_app/api/core/datasets/wid/wid_nincsh_posttax_equalsplit_p0p100.py
---
# Post-Tax National Income

## Overview

This dataset from the World Inequality Database (WID) measures **post-tax national income** across income and wealth distributions. Income or wealth shares. When the associated percentile is of the form 'pX', the raw data stores the share of total income or wealth detained by all the population between threshold pX and the top of the distribution. When the associated percentile is of the form 'pXpY', the raw data stores the share of the population between thresholds pX and pY.

## Variable Details

- **WID Variable Code**: `sdiincj992`
