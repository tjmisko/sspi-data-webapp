...
DatasetName: Social Benefits Averages (HOI) - Full Population
DatasetCode: WID_BENEFITAV_SOCIAL_HOI_P0P100
Description: Average social benefits other than social transfers in kind across all population percentiles for HOI (High Operating Income) groups. Social benefits represent government transfers to individuals and households, excluding in-kind transfers. Shows the average benefit distribution patterns specifically for high operating income populations.
Unit: >
    VEF; percentile p0p100; assbhoi992
Source:
  OrganizationCode: WID
  QueryCode: wid_all_data
DatasetProcessorFile: sspi_flask_app/api/core/datasets/wid/wid_benefitav_social_hoi_p0p100.py
---
