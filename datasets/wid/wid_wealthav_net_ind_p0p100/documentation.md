...
DatasetName: Net Personal Wealth Averages (Individuals) - Full Population
DatasetCode: WID_WEALTHAV_NET_IND_P0P100
Description: Average net personal wealth across all population percentiles for individuals. Net personal wealth is the total value of non-financial and financial assets (housing, land, deposits, bonds, equities, etc.) held by households, minus their debts. Shows the average wealth levels for different wealth groups.
Unit: >
    VND; percentile p0p100; ahweali992
Source:
  OrganizationCode: WID
  QueryCode: wid_all_data
DatasetProcessorFile: sspi_flask_app/api/core/datasets/wid/wid_wealthav_net_ind_p0p100.py
---
# Net Personal Wealth
