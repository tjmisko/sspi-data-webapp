...
DatasetName: Net Personal Wealth Shares (Equal - Top 10%
DatasetCode: WID_WEALTHSH_NET_EQUALSPLIT_P90P100
Description: Distribution of net personal wealth shares for the top 10% of earners for equal-split adults. Resources are split equally within couples while the base unit remains the individual. Net personal wealth is the total value of non-financial and financial assets (housing, land, deposits, bonds, equities, etc.) held by households, minus their debts.
Unit: >
    share; percentile p90p100; shwealj992
Source:
