...
DatasetCode: WID_NINCSH_POSTTAX_EQUALSPLIT_P0P50
Description: Distribution of post-tax national income shares for the bottom 50% of earners for equal-split adults. Resources are split equally within couples while the base unit remains the individual. Post-tax national income is the sum of primary incomes from all sectors minus taxes, reflecting income distribution after the operation of the tax and transfer system.
Unit: >
    share; percentile p0p50; sdiincj992
Source:
  OrganizationCode: WID
  QueryCode: wid_all_data
DatasetProcessorFile: sspi_flask_app/api/core/datasets/wid/wid_nincsh_posttax_equalsplit_p0p50.py
---
