...
DatasetName: Social Benefits Averages (HOI Alternative) - Full Population
DatasetCode: WID_BENEFITAV_SOCIAL_HOI_ALT_P0P100
Description: Alternative average social benefits other than social transfers in kind across all population percentiles for HOI (High Operating Income) groups. Social benefits represent government transfers to individuals and households, excluding in-kind transfers. Shows the average benefit distribution patterns using an alternative methodology.
Unit: >
    VEF; percentile p0p100; asschoi992
Source:
  OrganizationCode: WID
  QueryCode: wid_all_data
DatasetProcessorFile: sspi_flask_app/api/core/datasets/wid/wid_benefitav_social_hoi_alt_p0p100.py
---
