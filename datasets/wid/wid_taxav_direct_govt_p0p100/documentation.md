...
DatasetName: Direct Taxes Averages (Government) - Full Population
DatasetCode: WID_TAXAV_DIRECT_GOVT_P0P100
Description: Average direct taxes across all population percentiles for government sector. Direct taxes include social contributions and personal taxes on income and wealth. Shows the average tax collection patterns across different income groups from a government revenue perspective.
Unit: >
    VEF; percentile p0p100; ataxgoi992
Source:
  OrganizationCode: WID
  QueryCode: wid_all_data
DatasetProcessorFile: sspi_flask_app/api/core/datasets/wid/wid_taxav_direct_govt_p0p100.py
---
# Direct Taxes
...
[Direct taxes]=[Direct taxes on income and wealth]+[Social contributions]
