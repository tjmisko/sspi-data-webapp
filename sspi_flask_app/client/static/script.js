...
var dynamicDataTable=new Tabulator("#methodology-indicator-table",{ajaxURL:"/api/v1/query/metadata/indicator_details",headerSortClickElement:"icon",columns:[{title:"Indicator",field:"Indicator"},{title:"Indicator Code",field:"IndicatorCodes"},{title:"Indicator Description",field:"Description"},]});$(".widget-type-options-menu").hide()
