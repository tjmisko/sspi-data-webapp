...
def clean_wid_topten():
    """
    Clean the WID Dataset for the top 10% pre-tax income share
    """
    ...
    for cou in sspi_67:
        ...
        output_list = filter_wid_csv("WID_TOPTEN", raw["Raw"], cou, "p90p100", "sptincj992", year_range, metadata_csv_string=meta["Raw"])
