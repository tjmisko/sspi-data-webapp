#########################################################################
# Documentation: datasets/unsdg/unsdg_benfts_cash_poor/documentation.md #
#########################################################################
...
@dataset_collector("UNSDG_BENFTS_CASH_POOR")
def collect_unsdg_benfts_cash_poor(**kwargs):
    yield from collect_sdg_indicator_data("1.3.1", **kwargs)


@dataset_cleaner("UNSDG_BENFTS_CASH_POOR")
def clean_unsdg_benfts_cash_poor():
    sspi_clean_api_data.delete_many({"DatasetCode": "UNSDG_BENFTS_CASH_POOR"})
    source_info = sspi_metadata.get_source_info("UNSDG_BENFTS_CASH_POOR")
