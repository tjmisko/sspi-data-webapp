###########################################################
# Documentation: datasets/epi/epi_wstrec/documentation.md #
###########################################################
...
def clean_epi_nitrog():
    sspi_clean_api_data.delete_many({"DatasetCode": "EPI_WSTREC"})
    source_info = sspi_metadata.get_source_info("EPI_WSTREC")
    raw_data = sspi_raw_api_data.fetch_raw_data(source_info)
    parsed_epi_data = parse_epi_csv(raw_data[0]["Raw"], "EPI_WSTREC")
    sspi_clean_api_data.insert_many(parsed_epi_data)
    sspi_metadata.record_dataset_range(parsed_epi_data, "EPI_WSTREC")
