var table=new Tabulator("#api-link-coverage-data-table",{ajaxURL:"/api/v1/api_coverage",columns:[{title:"Indicator Code",field:"IndicatorCode",formatter:"textarea"},{title:"Collect Method Implemented",field:"collect_implemented",formatter:"tickCross",hozAlign:"center"},{title:"Compute Method Implemented",field:"compute_implemented",formatter:"tickCross",hozAlign:"center"}]});console.log("makeGraph.js loaded with chart.js version: "+Chart.version);const BarChartCanvas=document.getElementById('BarChart');const BarChart=new Chart(BarChartCanvas,{type:'bar',data:{},options:{}});makeBarChart('BIODIV')
raw=false
